...
def serve_chart():
    ...
    try:
        ...
        pass
    # No chart yet (e.g. fresh deploy before first EOD scan) — show a
    # placeholder instead of a stale snapshot.
    return HTMLResponse(
        '<body style="font-family:DM Sans,sans-serif;background:#0f172a;'
        'color:#e2e8f0;display:grid;place-items:center;height:100vh;margin:0">'
        '<div style="text-align:center">'
        '<h2>No chart yet</h2>'
        '<p>Chart generates after the next EOD scan (16:45 BKK).</p>'
        '</div></body>',
        status_code=200,
    )
